...
CREATE TRIGGER set_updated_at_instrucoesingredientes
BEFORE UPDATE ON instrucoesingredientes
FOR EACH ROW
EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER set_updated_at_instrucoesutensilios
BEFORE UPDATE ON instrucoesutensilios
FOR EACH ROW
EXECUTE FUNCTION update_updated_at_column();
