...
def get_produto_by_id(id_produto):
    return Produto.objects.get(id=id_produto)
...
def get_tipo_by_id(id_tipo):
    return Tipo.objects.get(id=id_tipo)
...
def get_categoria_by_id(id_categoria):
    return Categoria.objects.get(id=id_categoria)
...
def get_opcao_by_id(id_opcao):
    return Opcao.objects.get(id=id_opcao)
...
def get_menu_by_id(id_menu):
    return Menu.objects.get(id=id_menu)
