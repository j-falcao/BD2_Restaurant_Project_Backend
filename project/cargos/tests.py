...
class TesteAutenticacaoUtilizadores(APITestCase):
    ...
    def setUp(self):
        ...
        self.utilizador_garcom = User.objects.create_user(username="garcom", password="senha_garcom")
        self.utilizador_garcom.groups.add(self.grupo_garcom)

        self.utilizador_cozinheiro = User.objects.create_user(username="cozinheiro", password="senha_cozinheiro")
        self.utilizador_cozinheiro.groups.add(self.grupo_cozinheiro)

        self.utilizador_cliente = User.objects.create_user(username="cliente", password="senha_cliente")
        self.utilizador_cliente.groups.add(self.grupo_cliente)

        self.utilizador_administrador = User.objects.create_user(username="administrador", password="senha_admin")
        self.utilizador_administrador.groups.add(self.grupo_administrador)

    def test_utilizador_pode_pertencer_a_apenas_um_grupo(self):
        # Testa se um utilizador pode pertencer a apenas um grupo
        novo_utilizador = User.objects.create_user(username="novoutilizador", password="senha_novo")
    ...
    def test_utilizador_nao_pode_pertencer_a_varios_grupos(self):
        ...
        utilizador = User.objects.create_user(username="testeutilizador", password="senha_teste")
    ...
    def test_apenas_um_grupo_atribuido(self):
        ...
        utilizador = User.objects.create_user(username="utilizadorunico", password="senha_unica")
