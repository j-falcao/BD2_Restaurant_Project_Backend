...
CREATE OR REPLACE PROCEDURE create_mesas(_new_id_estado_mesa INT, _new_numero INT, _new_capacidade_maxima INT, _new_quantidade_clientes INT, OUT _new_mesa JSON)
LANGUAGE plpgsql
AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE update_mesas(id_mesa_in INT, _new_id_estado_mesa INT, _new_numero INT, _new_capacidade_maxima INT, _new_quantidade_clientes INT, OUT _new_mesa JSON)
LANGUAGE plpgsql
AS $$
BEGIN
    UPDATE mesas
...
CREATE OR REPLACE PROCEDURE create_servicos(_new_id_garcom INT, _new_id_mesa INT, _new_data_hora_inicio TIMESTAMP, _new_data_hora_fim TIMESTAMP, _new_preco_total DECIMAL(10, 2), OUT _new_servico JSON)
LANGUAGE plpgsql
AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE update_servicos(id_servico_in INT, _new_id_garcom INT, _new_id_mesa INT, _new_data_hora_inicio TIMESTAMP, _new_data_hora_fim TIMESTAMP, _new_preco_total DECIMAL(10, 2), OUT _new_servico JSON)
LANGUAGE plpgsql
AS $$
BEGIN
    UPDATE servicos
...
CREATE OR REPLACE PROCEDURE create_pedidosprodutos(_new_id_pedido INT, _new_id_produto INT, _new_id_cozinheiro INT, OUT _new_pedido_produto JSON)
LANGUAGE plpgsql
AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE update_pedidosprodutos(id_pedido_produto_in INT, _new_id_pedido INT, _new_id_produto INT, _new_id_cozinheiro INT, OUT _new_pedido_produto JSON)
LANGUAGE plpgsql
AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE create_reservas(_new_id_mesa INT, _new_data_hora TIMESTAMP, _new_minutos_antes INT, _new_minutos_depois INT, _new_id_servico INT, OUT _new_reserva JSON)
LANGUAGE plpgsql
AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE update_reservas(id_reserva_in INT, _new_id_mesa INT, _new_data_hora TIMESTAMP, _new_minutos_antes INT, _new_minutos_depois INT, _new_id_servico INT, OUT _new_reserva JSON)
LANGUAGE plpgsql
AS $$
BEGIN
    UPDATE reservas
